...
public class Bodata {
    ...
    @JsonProperty("shiftTransferOfGoodsDetails")
    private ShiftTransferOfGoodsDetails shiftTransferOfGoodsDetails;
    @JsonProperty("businessStatusDateTime")
    private String businessStatusDateTime;

    @JsonProperty("shiftTransferOfGoodsDetails")
    public ShiftTransferOfGoodsDetails getShiftTransferOfGoodsDetails() {
		return shiftTransferOfGoodsDetails;
	}

    @JsonProperty("shiftTransferOfGoodsDetails")
	public void setShiftTransferOfGoodsDetails(ShiftTransferOfGoodsDetails shiftTransferOfGoodsDetails) {
		this.shiftTransferOfGoodsDetails = shiftTransferOfGoodsDetails;
	}
