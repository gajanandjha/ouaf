...
@Controller
public class M1_TmshMnt {
	protected final Log logger = LogFactory.getLog(getClass());
	
	@RequestMapping("/ouaf/mobility/rest/ouaf/script/M1-TmshMnt/")
	public
	@ResponseBody
	String tmshMnt(HttpServletRequest request, HttpServletResponse response) throws IOException {
		GenericClass<com.tcs.gosi.pojo.tmshmnt.M1TmshMnt> gc = new GenericClass<>(com.tcs.gosi.pojo.tmshmnt.M1TmshMnt.class);
		HttpURLConnection httpCon = gc.doReq(request, response, "/ouaf/mobility/rest/ouaf/script/M1-TmshMnt/");
