...
@Controller
public class M1_PrMlFrDvc {
	protected final Log logger = LogFactory.getLog(getClass());
	
	@RequestMapping("/ouaf/mobility/rest/ouaf/script/M1-PrMlFrDvc/")
	public
	@ResponseBody
	String prMlFrDvc(HttpServletRequest request, HttpServletResponse response) throws IOException {
		GenericClass<com.tcs.gosi.pojo.prmlfrdvc.M1PrMlFrDvc> gc = new GenericClass<>(com.tcs.gosi.pojo.prmlfrdvc.M1PrMlFrDvc.class);
		HttpURLConnection httpCon = gc.doReq(request, response, "/ouaf/mobility/rest/ouaf/script/M1-PrMlFrDvc/");
